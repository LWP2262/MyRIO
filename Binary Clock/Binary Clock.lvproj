...
AddOutputFilter chunkFilter
		...
		<Item Name="binary sub.vi" Type="VI" URL="../binary sub.vi"/>
		<Item Name="Expansion.vi" Type="VI" URL="../Expansion.vi"/>
		<Item Name="Physical Display.vi" Type="VI" URL="../Physical Display.vi"/>
		<Item Name="Single Character Display.vi" Type="VI" URL="../Single Character Display.vi"/>
		<Item Name="Two Character Display (improved).vi" Type="VI" URL="../Two Character Display (improved).vi"/>
		<Item Name="Two Character Display Extension.vi" Type="VI" URL="../Two Character Display Extension.vi"/>
		<Item Name="Two Character Display.vi" Type="VI" URL="../Two Character Display.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
